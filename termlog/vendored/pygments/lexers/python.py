...
from pygments.lexer import Lexer, RegexLexer, bygroups, combined, default, do_insertions, include, using, words
from pygments.token import Comment, Error, Generic, Keyword, Name, Number, Operator, Other, Punctuation, String, Text
